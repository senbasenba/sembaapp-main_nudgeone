...
import { ChevronLeft, ChevronRight, Search, Heart, User, Bell, MapPin, Calendar, Star, Menu } from 'lucide-react'
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between text-sm text-muted-foreground">
          ...
          <span className="font-medium text-foreground">{property.price} / 泊</span>
        </div>
      </div>
    </Card>
  )
